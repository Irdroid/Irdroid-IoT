...
public class Persistence extends SQLiteOpenHelper implements BaseColumns {
  ...
  private static final String SQL_CREATE_ENTRIES =
      ...
      "CREATE TABLE " + TABLE_CONNECTIONS + " (" +
          ...
          COLUMN_HOST + TEXT_TYPE + COMMA_SEP +
           COLUMN_channel + TEXT_TYPE + COMMA_SEP +
  ...
  public void onCreate(SQLiteDatabase db) {
    ...
    initialValues.put("location", "Living Room");
    initialValues.put("host", "hwgroup-bg.com");
    initialValues.put("channel", "11111");
    initialValues.put("ClientID", "wirf1002");
    initialValues.put("port", "1883");
    initialValues.put("ssl", "0");
    initialValues.put("type", "1");
    initialValues.put("timeout", "1000");
    initialValues.put("keepalive", "0");
    initialValues.put("cleanSession", "0");
    initialValues.put("qos", "0");
    initialValues.put("retained", "0");
   
  
    db.insert(TABLE_CONNECTIONS, null, initialValues);
    
    initialValues.put("location", "Garden Lighting");
    initialValues.put("host", "hwgroup-bg.com");
    initialValues.put("channel", "1");
    initialValues.put("ClientID", "wirf1002");
    initialValues.put("port", "1883");
    initialValues.put("ssl", "0");
    ...
    initialValues.put("location", "Blinds Group I");
    initialValues.put("host", "hwgroup-bg.com");
    initialValues.put("channel", "1000");
    initialValues.put("ClientID", "wirf1002");
    initialValues.put("port", "1883");
    initialValues.put("ssl", "0");
    ...
    initialValues.put("location", "Blinds Group II");
    initialValues.put("host", "hwgroup-bg.com");
    initialValues.put("channel", "1001");
    initialValues.put("ClientID", "wirf1002");
    initialValues.put("port", "1883");
    initialValues.put("ssl", "0");
    initialValues.put("type", "2");
  ...
  public void persistConnection(Connection connection) throws PersistenceException {
    ...
    values.put(COLUMN_location, connection.getlocation());
    values.put(COLUMN_HOST, connection.getHostName());
    values.put(COLUMN_channel, connection.getchannel());
    ...
    values.put(COLUMN_type, connection.getType());
  ...
  public List<Connection> restoreConnections(Context context) throws PersistenceException
  {
    ...
    for (int i = 0; i < c.getCount(); i++) {
      ...
      String channel = c.getString(c.getColumnIndexOrThrow(COLUMN_channel));
      ...
      connection = Connection.createConnection(clientID, location,host,channel, port, context, ssl, type);
