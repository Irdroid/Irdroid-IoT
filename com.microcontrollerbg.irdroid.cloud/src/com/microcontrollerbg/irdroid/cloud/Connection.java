...
public class Connection {
   ...
   */
  public static Connection createConnection(String clientId, String location, String host,String channel,
      int port, Context context, boolean sslConnection, int type) {
    String handle = null;
    String uri = null;
    if (sslConnection) {
      uri = "ssl://" + host + ":" + port;
    ...
    return new Connection(handle, clientId, location ,host, channel, port, context, client, sslConnection, type);
   ...
   * @param sslConnection true if the connection is secured by SSL
   */
  public Connection(String clientHandle, String clientId,String location ,String host,String channel,
      int port, Context context, MqttAndroidClient client, boolean sslConnection, int type) {
    //generate the client handle from its hash code
    this.clientHandle = location;
  ...
  public String toString() {
    StringBuffer sb = new StringBuffer();
    sb.append(location + " / Switch channel: " + channel);
    sb.append("\n ");
